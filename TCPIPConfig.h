 ...
 * Yale                 04/09/2010  Port to PIC24 Web Server Demo Board
 ********************************************************************/
...
#define STACK_USE_DHCP_CLIENT                   // Dynamic Host Configuration Protocol client for obtaining IP address and other parameter
...
#define MY_DEFAULT_MAC_BYTE5           (0x10)    // factory programmed MAC
 ...
 */
    ...
    #define END_OF_TCP_SOCKET_TYPES
        ...
        // 40+(TX FIFO size)+(RX FIFO size) bytes of
        // TCP_*_RAM each.
        ...
        {        
            ...
            {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 512, 512}, // to serve 2 http clients, 3 sockets are needed: one listen socket (port 80) and 2 http client sockets
            {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 512, 512},
            {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 512, 512},
            {TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 200, 200},
            //{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 125, 100},
...
// -- HTTP2 Server options -----------------------------------------------
    ...
    #define HTTP_MAX_DATA_LEN      (401u)      // set this to the largest WebSocket frame payload length you expect to send
